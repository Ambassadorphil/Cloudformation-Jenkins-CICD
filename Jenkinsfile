...
//         }
        stage('Update Prod Stack') {
            steps {
            sh "aws cloudformation create-stack --stack-name General --template-body file://ventura-prod-env-infra.yaml --parameters file://ventura-infra-parametafile.json --region 'us-east-1'"
            }
        }
    }
    post {
           always {
             ...
             slackSend channel: '#philip-cloudformation-cicd', //update and provide your channel name
